...
describe('page theme token styles', (): void => {
  it('uses design tokens in default layout chrome', (): void => {
    ...
    expect(welcomeTabRule).toContain('border: var(--button-border-width) solid var(--button-border);');
    expect(welcomeTabRule).toContain('border-radius: var(--control-radius);');
    expect(welcomeTabRule).toContain('box-shadow: var(--button-shadow);');
    expect(welcomeTabRule).toContain('box-shadow var(--motion-duration-base) var(--motion-easing-standard)');
    expect(welcomeTabRule).toContain('transform var(--motion-duration-fast) var(--motion-easing-press)');
    expect(welcomeTabHoverRule).toContain('border-color: var(--input-focus-border);');
    expect(welcomeTabHoverRule).toContain('box-shadow: var(--button-active-shadow);');
    expect(welcomeTabActiveRule).toContain('box-shadow: var(--button-pressed-shadow);');
    expect(welcomeTabActiveRule).toContain('transform: translate(var(--interaction-press-offset), var(--interaction-press-offset));');
